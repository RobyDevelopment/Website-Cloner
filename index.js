...
const app = express();
app.get('/', (req, res) => {
res.send('Website Cloner by .zevs!')
});
app.listen(3000, () => {
})
...
console.log("\x1b[44m%s\x1b[0m", `\x1b[33mWEBSITE \x1b[32mCLONER \x1b[35mBY \x1b[36m.zevs!`);
console.log()
...
console.log("\x1b[32m%s\x1b[0m", `Succesfully Downloading The Website`);
}).catch((err) => { 
console.clear()
console.log("\x1b[44m%s\x1b[0m", `\x1b[33mWEBSITE \x1b[32mCLONER \x1b[35mBY \x1b[36m.zevs!`);
console.log()
